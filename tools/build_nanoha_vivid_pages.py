...
CHARACTERS = {
    ...
    "luca": ("Luca is one of Harry Tribeca's school friends and followers, alongside Linda and Mia. She supports Harry during the Intermiddle Championship storyline.", "The local database contains [[luca]] as a character tag, but the name is broad; confirm the depicted franchise when tagging.", "Luca"),
